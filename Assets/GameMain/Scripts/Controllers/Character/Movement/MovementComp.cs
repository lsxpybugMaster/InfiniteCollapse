<<<<<<< HEAD:Assets/GameMain/Scripts/Controllers/Character/Movement/MovementComp.cs
...
namespace Assets.GameMain.Scripts.Character.Movement
{
    public class MovementComp : MonoBehaviour, ILooper
    {
        ...
        private void Start()
        {
            _mBlackHoleController = GameObject.FindGameObjectWithTag("BlackHole").GetComponent<BlackHoleController>();
            mInputManager = InputManager.Instance;
        }
...
>>>>>>> 26666dc2c3ec46eac4a0efdb75afb37f83cb6687:Assets/GameMain/Scripts/Character/Movement/MovementComp.cs
